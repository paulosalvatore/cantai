...
export default function NewRoomPage() {
  ...
  if (room) {
    return (
      <main style={{ maxWidth: 480, margin: "0 auto", padding: "2.5rem 1rem" }}>
        ...
        <h1 style={{ fontSize: "1.75rem", marginBottom: "0.25rem" }}>🎤 {t("createdTitle")}</h1>
        <p style={{ color: "var(--text-muted)", marginBottom: "2rem" }}>
          {t.rich("createdSubtitle", {
            name: room.name,
            b: (chunks) => <strong style={{ color: "var(--text)" }}>{chunks}</strong>,
          })}
        </p>
        ...
        <section style={{ background: "var(--surface)", borderRadius: "var(--radius)", padding: "1.25rem", marginBottom: "1.25rem", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", margin: "1rem 0" }}>
            <QrCode value={joinUrl} size={220} title={t("qrTitle", { name: room.name })} />
          </div>
  ...
  return (
    <main style={{ maxWidth: 480, margin: "0 auto", padding: "3rem 1rem" }}>
      ...
      <h1 style={{ fontSize: "2rem", marginBottom: "0.25rem" }}>🎤 {t("createTitle")}</h1>
      <p style={{ color: "var(--text-muted)", marginBottom: "2rem" }}>
        {t("createIntro")}
      </p>
